...
var listPaymentMethodsCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		request := &transfers.ListPaymentMethodsRequest{}

		response, err := transfersService.ListPaymentMethods(ctx, request)
		if err != nil {
...
func init() {
	rootCmd.AddCommand(listPaymentMethodsCmd)
	listPaymentMethodsCmd.Flags().StringP(utils.FormatFlag, "z", "false", "Pass true for formatted JSON. Default is false")
}
